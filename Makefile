...
all: ${PARALLEL_CORPUS} ${TRAIN_DATA_VN} ${DEV_0} ${DEV_1} ${TEST_A} ${TEST_DATA} ${TRANSLATOR_DATA_VN} ${TRANSLATOR_DATA_DEFAULT} ${TRANSLATOR_DATA_DEFAULT_32} ${TRANSLATOR_DATA_ALL} ${TRANSLATOR_DATA_ALL_NMT} ${TRANSLATOR_DATA_DEFAULT_NMT} ${TRANSLATOR_DATA_DEFAULT_NMT_5} ${TRANSLATOR_DATA_ALL_NMT_5} ${TRANSLATOR_DATA_DEFAULT_2} ${TRANSLATOR_DATA_DEFAULT_32_2}
